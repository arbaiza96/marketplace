  ...
  <?php 
    ...
    $productos = $i->obtener_carrito($_userid);
  ...
  ?>  
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h3 class="m-0 text-dark"> Carrito de compras </h3>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12 mb-3 d-flex flex-wrap align-items-start">
            ...
            <?php if(empty($productos)){
              echo "<div class='col-md-12 text-center py-5 text-muted'>
                ...
                <span>PUEDES <a href='../marketplace/'>BUSCAR PRODUCTOS</a> PARA AGREGARLOS AL CARRITO </span>
              </div>";
            }else{ ?>
              <?php 
