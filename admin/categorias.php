                  ...
                  <div class="card-body">
                    <div class="col p-0 d-flex justify-content-end">
                      <div class="">
                        ...
                        <button class='btn btn-primary' id='btnAgregarProveedor'>NUEVA CATEGORÍA</button>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table class='table table-striped table-hover table-sm border mt-3'>
                        ...
                        <tbody id='lista_categorias'>
                          <tr>
                            <td colspan='3' class='text-center py-3'>LISTA DE CATEGORÍAS</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
              ...
              <script>
                ...
                function cargar_listado_proveedores(){
                  $.ajax({
                    ...
                    data: {
                      modelo: 'empresas',
                      accion: 'cargar_lista_categorias',
                      id: _id,
                    },
                    beforeSend : function(){
                      let e = $("#lista_categorias");
                      e.html("");
                      e.append("\
                        <tr>\
                          <td colspan='3'>\
                    ...
                    e.html("");
                    if(data.length == 0){
                      e.append("<tr><td colspan='3' class='text-center py-3'>NO SE HAN AGREGADO REGISTROS</td></tr>");
                      return false;
                    }
                    let contador = 0;
                    $.each(data, function(index, val) {
                      ...
                      $("#btnEliminar_"+val.id).click(function(){
                        alertify.confirm("Se eliminará el registro de la categoría '"+val.categoria+"' ¿Desea proceder?", 
                        function(){
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mb-3 col row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" id='txtNombre' autocomplete="off" class='form-control' placeholder="NOMBRE DE LA CATEGORÍA">
                      </div>
                    </div>
                    <div class="col p-0">
